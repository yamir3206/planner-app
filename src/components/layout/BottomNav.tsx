...
import { LayoutDashboard, CalendarDays, ListChecks, Timer, BarChart3, Settings, BookOpen, Trophy } from 'lucide-react'
const items = [
  { to: '/', icon: LayoutDashboard, label: 'خانه' },
  { to: '/today', icon: ListChecks, label: 'امروز' },
  { to: '/timer', icon: Timer, label: 'تایمر', primary: true },
  { to: '/gamification', icon: Trophy, label: 'امتیاز' },
